...
class ProductTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $products = [
            ...
            ['name_en' => 'cover mark', 'name_ch' => '傲丽', 'name_th' => 'อ้าว ลี่', 'category_id' => 1, 'created_at' => now(), 'updated_at' => now()],
            ...
            ['name_en' => 'marco polo', 'name_ch' => '马可波罗', 'name_th' => 'ม๋า เค่อ ปัว หลัว', 'category_id' => 4, 'created_at' => now(), 'updated_at' => now()],
            ['name_en' => 'marco spade', 'name_ch' => 'MARCO SPADE', 'name_th' => 'ม๋า เค่อ สเปช', 'category_id' => 4, 'created_at' => now(), 'updated_at' => now()],
            ['name_en' => 'mira madison', 'name_ch' => 'MIRA MADISON', 'name_th' => 'มิรา มา ดิ ซัน', 'category_id' => 4, 'created_at' => now(), 'updated_at' => now()],
            ['name_en' => 'percy grey', 'name_ch' => 'PERCY GREY', 'name_th' => 'เพ้อ ซี เก', 'category_id' => 4, 'created_at' => now(), 'updated_at' => now()],
            ...
            ['name_en' => 'hush puppies', 'name_ch' => '暇步士', 'name_th' => 'เซีย ปู้ ซื่อ', 'category_id' => 5, 'created_at' => now(), 'updated_at' => now()],
            ...
            ['name_en' => 'giorgio armani', 'name_ch' => '阿玛尼', 'name_th' => 'อา มา นี๋', 'category_id' => 6, 'created_at' => now(), 'updated_at' => now()],
            ['name_en' => 'paco rabanne', 'name_ch' => '帕高', 'name_th' => 'พ่า เกา', 'category_id' => 6, 'created_at' => now(), 'updated_at' => now()],
            ...
            ['name_en' => "levi's", 'name_ch' => '李维斯', 'name_th' => 'หลี่ เหวย ซือ', 'category_id' => 7, 'created_at' => now(), 'updated_at' => now()],
            ...
            ['name_en' => 'defry o1', 'name_ch' => 'DEFRY O1', 'name_th' => 'ดิ ไฟ โอ วัน', 'category_id' => 7, 'created_at' => now(), 'updated_at' => now()],
            ...
            ['name_en' => 'g-star raw', 'name_ch' => 'G-STAR RAW', 'name_th' => 'จี สตา เรอ', 'category_id' => 7, 'created_at' => now(), 'updated_at' => now()],
            ...
            ['name_en' => 'john henry', 'name_ch' => '约翰亨利', 'name_th' => 'เยว ฮั่น เหิน ลี่', 'category_id' => 7, 'created_at' => now(), 'updated_at' => now()],
            ...
            ['name_en' => 'polo travel club', 'name_ch' => 'POLO TRAVEL CLUB', 'name_th' => 'เปา หลัว ทรา เวอ คลับ', 'category_id' => 9, 'created_at' => now(), 'updated_at' => now()],
